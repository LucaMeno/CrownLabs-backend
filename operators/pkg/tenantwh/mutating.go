...
// TenantDefaulter labels Tenants.
...
func (tm *TenantDefaulter) Default(ctx context.Context, obj runtime.Object) error { //nolint:gocritic // the signature of this method is imposed by controller runtime.
...
func (twh *TenantDefaulter) DecodeTenant(obj runtime.RawExtension) (tenant *clv1alpha2.Tenant, err error) {
	if twh.Decoder == nil {
